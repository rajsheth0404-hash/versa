...
export const MODULE_PLAYLIST_CATALOG: Record<string, ModuleLectureItem[]> = {
  ...
  // =========================================================================
  'mod-oop-1': [
    { id: 'oop1-brocode', lessonNumber: 1, title: 'Object-Oriented Programming (Classes & Objects) - BroCode', duration: 'Full Series', videoId: '', playlistId: 'PLKqZXXNji-5U', youtubeUrl: 'https://youtube.com/playlist?list=PLKqZXXNji-5U&si=yCRmZlY8TPBtLAB5' },
  ],
  'mod-oop-2': [
